...
Real-time price data is fetched from the CoinGecko public API, for example: "GET https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=usd", which returns { "bitcoin": { "usd": 65432 } }.
